...
public class OllamaAiService {
    ...
    public OllamaAiService(OllamaChatModel ollamaChatModel, ChatMemory chatMemory) {
    ...
    public String chat(String message, String chatId) {
        ...
        this.chatMemory.add(chatId, new AssistantMessage(response, Map.of("model", "OLLAMA-qwen2.5:0.5b")));
